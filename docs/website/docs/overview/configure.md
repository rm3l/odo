...
| `ODO_CONTAINER_RUN_ARGS`   | Comma-separated list of options to pass to Podman or Docker (see `PODMAN_CMD`) when building and pushing images.                                                                                                                                                                                                                                                               | v3.10.0       | `--platform=linux/amd64;--log-level=info` |
| `ODO_CONTAINER_RUN_ARGS` | Comma-separated list of options to pass to Podman  when running `odo` against Podman.                                                                                                                                                                                                                                                                                          | v3.10.0       | `false`                                   |
