...
module.exports = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      ...
      content: `⭐️ Hey there!!! Love odo? Support us by giving it a star on <a target="_blank" rel="noopener noreferrer" href="https://github.com/redhat-developer/odo">GitHub</a>! ⭐️`,
    },
    navbar: {
      title: 'odo',
      logo: {
